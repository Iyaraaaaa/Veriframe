...
void main() {
  ...
  // Add import for FilePicker if not exists
  if (!content.contains("import 'package:file_picker/file_picker.dart';")) {
    content = content.replaceFirst("import 'package:flutter/material.dart';", "import 'package:flutter/material.dart';\nimport 'package:file_picker/file_picker.dart';");
  }
  if (!content.contains("import 'verify.dart';")) {
    content = content.replaceFirst("import 'package:flutter/material.dart';", "import 'package:flutter/material.dart';\nimport 'verify.dart';");
  }
...
''');
          ...
          Center(
            child: Column(
              children: [
                ...
                Text(
                  'Detect deepfakes, manipulated videos, and synthetic media using advanced AI analysis (EfficientViT, CrossEfficientViT, and MTCNN) and explainable forensic reasoning.',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 14,
                    color: text,
                ...
                const SizedBox(height: 16),
                Text(
                  'VeriFrame performs real AI-powered deepfake detection and forensic analysis. It analyzes uploaded videos, video links, and live streams using real backend inference to determine whether media is authentic or manipulated.',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 13,
                    color: muted,
  ...
  Widget _buildNewHowItWorksCard(bool isDark, Color cardBg, Color text, Color muted) {
    final steps = [
      ...
      {'title': 'Face Detection', 'desc': 'Identify and crop facial regions across frames using MTCNN.'},
      {'title': 'AI Analysis', 'desc': 'Process frames using real EfficientViT & CrossEfficientViT models.'},
      {'title': 'Authenticity Score', 'desc': 'Retrieve final confidence and risk level from backend.'},
