...
class _NotificationsPageState extends State<NotificationsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final Map<String, String> localizedTitles = {
      "appointmentReminder": loc.appointmentReminder ?? "appointmentReminder",
      "paymentConfirmation": loc.paymentConfirmation ?? "paymentConfirmation",
      "newDoctorAdded": loc.newDoctorAdded ?? "newDoctorAdded",
    };

    final Map<String, String> localizedMessages = {
      "appointmentMessage": loc.appointmentMessage ?? "appointmentMessage",
      "paymentMessage": loc.paymentMessage ?? "paymentMessage",
      "doctorMessage": loc.doctorMessage ?? "doctorMessage",
    };
