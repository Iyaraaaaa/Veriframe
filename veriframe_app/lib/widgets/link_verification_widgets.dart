...
/// Supported platforms header displaying platform coverage for link verification
class LinkSupportedPlatformsHeader extends StatelessWidget {
  const LinkSupportedPlatformsHeader({super.key});

  @override
  Widget build(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final surfaceColor = isDark ? const Color(0xFF162035) : const Color(0xFFF1F5F9);
    final borderColor = isDark ? const Color(0xFF1C2740) : const Color(0xFFE2E8F0);
    final textColor = isDark ? const Color(0xFFE8F0FF) : const Color(0xFF0F172A);

    final platforms = [
      {'name': 'YouTube', 'icon': Icons.play_circle_fill_rounded, 'color': const Color(0xFFFF0000)},
      {'name': 'Facebook', 'icon': Icons.facebook_rounded, 'color': const Color(0xFF1877F2)},
      {'name': 'Instagram', 'icon': Icons.camera_alt_rounded, 'color': const Color(0xFFE4405F)},
      {'name': 'TikTok', 'icon': Icons.music_note_rounded, 'color': const Color(0xFF00F2FE)},
      {'name': 'Vimeo', 'icon': Icons.video_library_rounded, 'color': const Color(0xFF1AB7EA)},
      {'name': 'Direct MP4', 'icon': Icons.insert_drive_file_rounded, 'color': const Color(0xFF10B981)},
    ];
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(Icons.verified_outlined, size: 16, color: Color(0xFF00C8FF)),
